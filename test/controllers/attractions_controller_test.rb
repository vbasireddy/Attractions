...
class AttractionsControllerTest < ActionController::TestCase
  ...
  test "should create attraction" do
    assert_difference('Attraction.count') do
      post :create, attraction: { description: @attraction.description, entry_fee: @attraction.entry_fee, name: @attraction.name, rating: @attraction.rating, web: @attraction.web }
    end
  ...
  test "should update attraction" do
    patch :update, id: @attraction, attraction: { description: @attraction.description, entry_fee: @attraction.entry_fee, name: @attraction.name, rating: @attraction.rating, web: @attraction.web }
    assert_redirected_to attraction_path(assigns(:attraction))
  end
